...
namespace CampusERP.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260812174655_AddAttendanceQrSession")]
    partial class AddAttendanceQrSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CampusERP.Domain.Entities.AttendanceQrSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AttendanceSessionId", "IsActive");

                    b.HasIndex("ExpiresOn", "IsActive");

                    b.HasIndex("InstitutionId", "CampusId", "AttendanceSessionId");
            ...
            modelBuilder.Entity("CampusERP.Domain.Entities.AttendanceQrSession", b =>
                {
                    ...
                    b.HasOne("CampusERP.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
